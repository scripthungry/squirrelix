defmodule SquirrElixRuntimeDecodingTest do
  ...
  @modules [
    SquirrElix.RuntimeDecodeHelperTest.SQL,
    SquirrElix.RuntimeEncodeHelperTest.SQL,
    SquirrElix.RuntimeCommandTest.SQL,
    SquirrElix.RuntimeQueryTest.SQL,
    SquirrElix.RuntimeEnumTest.SQL
  ]
  ...
  describe "postgres enum strings" do
    ...
    test "generated query functions round-trip enum strings" do
      ...
      code =
        Codegen.generate_module(SquirrElix.RuntimeEnumTest.SQL, [query],
          version: "v-test",
    ...
    test "multiple enum-using queries share one runtime helpers section" do
      ...
      code =
        Codegen.generate_module(SquirrElix.RuntimeEnumTest.SQL, queries,
          version: "v-test",
          postgrex: RuntimeEnumMock
        )
  ...
  describe "command queries" do
    test "insert_with_no_returned_values_returns_just_ok" do
      ...
      code =
        Codegen.generate_module(SquirrElix.RuntimeCommandTest.SQL, [query],
          version: "v-test",
  ...
  describe "generated query functions" do
    test "encoding query parameters and decoding returned rows" do
      ...
      code =
        Codegen.generate_module(SquirrElix.RuntimeQueryTest.SQL, [query],
          version: "v-test",
          postgrex: RuntimeDecodingMock
        )
  ...
  defp decode_row(row, columns) do
    ...
    code =
      Codegen.generate_module(SquirrElix.RuntimeDecodeHelperTest.SQL, [query],
        version: "v-test",
        postgrex: RuntimeDecodingMock
      )
  ...
  defp encode_params(values, types) do
    ...
    code =
      Codegen.generate_module(SquirrElix.RuntimeEncodeHelperTest.SQL, [query],
        version: "v-test",
