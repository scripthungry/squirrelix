defmodule SquirrelixirErrorIsolationTest do
  ...
  describe "query directory error isolation" do
    test "from_files keeps parse errors aligned with their files" do
      dir = Squirrelixir.TestSupport.tmp_dir!("squirrelixir-error-isolation")
      ...
      assert %QueryDirectory{
               ...
               errors: [%Squirrelixir.Error.QueryFileHasInvalidName{file: ^invalid}]
