defmodule SquirrElix.Error.CannotReadFile do
  @moduledoc """
...
defmodule SquirrElix.Error.QueryFileHasInvalidName do
  @moduledoc """
...
defmodule SquirrElix.Error.CannotOverwriteFile do
  @moduledoc """
...
defmodule SquirrElix.Error.CannotWriteFile do
  @moduledoc """
...
defmodule SquirrElix.Error.OutdatedFile do
  @moduledoc """
...
defmodule SquirrElix.Error.DuplicateReturnColumns do
  @moduledoc """
...
defmodule SquirrElix.Error.QueryHasInvalidColumn do
  @moduledoc """
...
defmodule SquirrElix.Error.MissingQueryMetadataField do
  @moduledoc """
...
defmodule SquirrElix.Error.QueryHasInvalidEnum do
  @moduledoc """
...
defmodule SquirrElix.Error.PostgresSyntaxError do
  @moduledoc """
...
defmodule SquirrElix.Error.MissingPostgresTable do
  @moduledoc """
...
defmodule SquirrElix.Error.MissingPostgresColumn do
  @moduledoc """
...
defmodule SquirrElix.Error.MissingPostgresConstraint do
  @moduledoc """
...
defmodule SquirrElix.Error.PostgresInferenceError do
  @moduledoc """
...
defmodule SquirrElix.Error do
  ...
  defp format_outdated_file_error(%OutdatedFile{} = error) do
    [
      "Error: Outdated file",
      "",
      "It looks like #{error.file} is outdated, try running `mix squirr_elix.gen` to generate a new up to date version."
    ]
    |> Enum.join("\n")
  end
  ...
  defp format_cannot_overwrite_file_error(%CannotOverwriteFile{} = error) do
    [
      ...
      "",
      "It looks like #{error.file} already exists and was not generated by SquirrElix, it cannot be overwritten!",
      "Hint: Rename the file and run `mix squirr_elix.gen` again."
    ]
    |> Enum.join("\n")
  end
