...
defmodule Squirrelix.Error do
  ...
  defp format_outdated_file_error(%OutdatedFile{} = error) do
    [
      "Error: Outdated file",
      "",
      "It looks like #{error.file} is outdated, try running `mix squirrelix.gen` to generate a new up to date version."
    ]
    |> Enum.join("\n")
  end
  ...
  defp format_cannot_overwrite_file_error(%CannotOverwriteFile{} = error) do
    [
      ...
      "Hint: Rename the file and run `mix squirrelix.gen` again."
    ]
    |> Enum.join("\n")
  end
