defmodule Squirrelixir do
  ...
  Generation and checking accept a *query source* in one of two forms:
    ...
    * An inferrer — a `(query -> {:ok, keyword()} | {:error, struct()})` function
      or a module implementing `Squirrelixir.Inference.Describer`. The Mix task
  ...
  enums, `map()` with `required/1` and `optional/1` for row shapes, and plain
  keyword options rather than Gleam records or custom enum ADTs.
  """
  ...
  @type query_source :: metadata() | Squirrelixir.Inference.describer()
